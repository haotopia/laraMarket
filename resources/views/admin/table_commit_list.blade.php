        ...
        <form class="am-form">
          <fieldset>
            ...
            <div class="am-form-group">
              <label>商品名称</label>
              <input type="text" id="goods_name" placeholder="请输入商品名称" value="{{$goods->name}}">
            </div>
            ...
            <div class="am-form-group am-form-file">
              ...
              <div class="am-form-group am-form-file">
                @if($goods->img)
                        <img class="thumbnail img-responsive" src="{{ $goods->img }}" width="200" />
                    @endif
            ...
            <div class="am-form-group">
              <label>商品价格</label>
              <input type="text" id="goods_price" placeholder="请填写商品价格" value="{{$goods->price}}">
            </div>
            <div class="am-form-group">
              <label>商品库存</label>
              <input type="text" id="goods_save" placeholder="请填写商品库存" value="{{$goods->quntity}}">
            </div>
            <div class="am-form-group">
            ...
            <div style="display: none;"><input id="goodsShow" value="{{$goods->id}}"/></div>
            <div class="am-form-group">
              <label for="doc-ta-1">请输入商品描述</label>
              <textarea rows="5" id="goods_des">{{$goods->abstract}}</textarea>
            </div>
            <p>
